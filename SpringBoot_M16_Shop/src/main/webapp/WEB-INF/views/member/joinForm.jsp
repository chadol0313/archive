...
<form id="join" action="join" method="post" name="formm">
	...
	<fieldset>
		...
		<label>Address</label><input type="text" id="sample6_address" size="50" name="address1"   value="${dto.address1}" readonly><br>
		<label>detailAddress</label><input type="text" id="sample6_detailAddress"  name="address2"   value="${dto.address2}" size="50"><br>
		<label>extraAddress</label><input type="text" id="sample6_extraAddress"  name="address3"   value="${dto.address3}" readonly><br>
